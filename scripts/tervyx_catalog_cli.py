...
try:
    from catalog.manual_catalog import ManualCatalogEntry, ManualEntryCatalog
    CatalogEntry = ManualCatalogEntry  # type: ignore[assignment]
    EntryCatalog = ManualEntryCatalog  # type: ignore[assignment]
