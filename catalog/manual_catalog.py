...
class ManualEntryCatalog:
    ...
    def __init__(self, catalog_dir: Optional[Path] = None) -> None:
        ...
        self.entries: List[ManualCatalogEntry] = []
        self._load_entries()
    ...
    def _load_entries(self) -> None:
        with self.catalog_path.open("r", encoding="utf-8") as f:
            ...
            self.entries = [ManualCatalogEntry(row) for row in reader]
    ...
    def get_next_batch(
        ...
        filtered: Iterable[ManualCatalogEntry] = (
            entry
            for entry in self.entries
...
__all__ = ["ManualEntryCatalog", "ManualCatalogEntry"]
